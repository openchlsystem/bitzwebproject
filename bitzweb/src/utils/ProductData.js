...
export const productFeatures = [
  ...
  },
  {
    ...
    Product_id: 1,
    Module: "call center",
    Feature: "Anonymity and Confidentiality",
    Description:
      "Provide a safe and secure environment for survivors to report incidents and seek assistance, as violence can occur at any time.",
  ...
  },
  {
    ...
    Product_id: 1, // This corresponds to OPENCHS
    Module: "call center",
    Feature: "Documentation and Record Management",
    Description:
      "Keep detailed records of reported incidents to track trends, identify hotspots, and inform policy decisions.",
  ...
  },
  {
    ...
    Feature: "Feedback and Complaint Management",
    Description:
      "Agents can create cases directly from calls, texts, and chat and immediately categorize the case for escalation and reporting.",
  ...
  },
  {
    ...
    Description:
      "Gain insights into the performance of your call center and identify areas for improvement.",
