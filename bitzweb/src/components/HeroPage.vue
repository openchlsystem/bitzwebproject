    ...
    watch(() => {
      ...
      if (route.path === '/crmfeatures') {
        ...
        title.value = 'Sacco CRM Made Simple: Connect, Streamline, Grow.',
          description.value = 'Simplify your Saccos operations with our easy - to - use CRM.It helps you connect better with members, streamline your tasks, and boost your growth effortlessly.Enjoy smoother Sacco management with us.'
        buttonText.value = 'Request for Demo ',
      ...
      if (route.path === '/softwareportfolio') {
        title.value = 'Core Banking System for SACCOS and Microfinance.',
          description.value = 'Efficiently Manage Operations, Elevate Member Services, and Drive Growth with Ease.'
        buttonText.value = 'Request for Demo ',
          imageUrl.value = require("../assets/images/stock/35262247_8292064.jpeg");
      }

      if (route.path === '/uiservices') {
        title.value = 'Crafting Seamless Customer Journeys: Elevating User Experiences through Tailored UI/UX Services.',
          description.value = 'At our UI/UX design studio, we are passionate about shaping exceptional user experiences that enhance the entire customer journey.Our tailored UI / UX services ensure your digital interfaces not only look stunning but also function intuitively, resulting in a seamless and delightful user journey from start to finish.Let us transform your design vision into a user - centric reality.'
        buttonText.value = 'Free Consultation ',
          imageUrl.value = 'https://picsum.photos/500/500'
      }

      if (route.path === '/niche') {
        title.value = 'Modern-Day Agile Project Management: Ideation to Execution with Our Expert Scrum Team.',
          description.value = ' With our expert Scrum team by your side, we will transform your ideas into reality, from ideation to execution.We specialize in dynamic and efficient project management, ensuring your software projects not only keep pace with todays demands but also thrive in a rapidly evolving landscape.'
        buttonText.value = 'Request for Demo ',
          imageUrl.value = 'https://picsum.photos/500/500'
      }

      if (route.path === '/digital') {
        title.value = 'Professional Digital Strategy: Automate, Raise Awareness, Engage, and Convert for Ultimate Success!',
          description.value = 'At our professional digital marketing service, we specialize in crafting and executing digital strategies that drive results. Our expert team leverages automation to maximize efficiency and streamline your marketing efforts. We focus on raising brand awareness, engaging your target audience, and ultimately converting leads into loyal customers. Join us on a journey that redefines digital marketing and elevates your online presence to new heights.'
        buttonText.value = 'Free Consultation',
          imageUrl.value = require("../assets/images/stock/digital marketing.jpeg");
      }
      if (route.path === '/webportfolio') {
        title.value = 'Elevate Your Online Presence: Craft, Engage, Convert, and Thrive with Our Web Design Mastery!',
          description.value = 'Our expertise lies in crafting visually stunning and user-friendly websites that not only capture attention but also engage and convert visitors effectively. With a professional approach and a focus on digital strategy, we are here to help you automate your online success, raise awareness, and achieve your business goals.',
    ...
    onMounted(() => {
      ...
      if (route.path === '/services') {
        title.value = 'Our Services',
          description.value = 'Our Services'
